plot1 <- function(){
      ...
      df <- read.table("/Users/Coursera/feb_household_power_consumption.txt", sep=";",header=TRUE,stringsAsFactors=FALSE)
      ...
      png(filename="plot1a.png", width=480, height=480, bg="white")
